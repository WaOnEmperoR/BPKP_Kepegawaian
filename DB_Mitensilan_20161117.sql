...
CREATE TABLE IF NOT EXISTS `diklat` (
  ...
  `Jenis_Diklat_ID_Jenis_Diklat` int(11) NOT NULL,
  `Pegawai_ID_Pegawai` int(11) NOT NULL,
  PRIMARY KEY (`ID_Diklat`,`Jenis_Diklat_ID_Jenis_Diklat`,`Pegawai_ID_Pegawai`),
...
CREATE TABLE IF NOT EXISTS `sertifikasi` (
  ...
  `Jenis_Sertifikasi_ID_Jenis_Sertifikasi` int(11) NOT NULL,
  `Pegawai_ID_Pegawai` int(11) NOT NULL,
  PRIMARY KEY (`ID_Sertifikasi`,`Jenis_Sertifikasi_ID_Jenis_Sertifikasi`,`Pegawai_ID_Pegawai`),
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`) VALUES
	(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, '6aryoSHnAWO4Iwgsgl7pJO', 1268889823, 1479346917, 1, 'Admin', 'istrator', 'ADMIN', '1234567890'),
	(2, '::1', 'themusketeer17@gmail.com', '$2y$08$Bt0T8zLxKzRkrLwpbiiUruLXWmnxuCpfFpmqwgTn13oBGN06jyjZ.', NULL, 'themusketeer17@gmail.com', NULL, 'WwojVW7Xf8DEAQLfx21dy.6975cb86b736e3d497', 1479083403, NULL, 1478674255, NULL, 1, 'Rachmawan', 'Atmaji', 'BPPT', '082213030223'),
	(3, '::1', 'indonesian_emperor@yahoo.co.id', '$2y$08$eDNs6huNm/N9.R.Qf9qZCuqBhwRx6bcXgmUOApHNFuqAJsO7r/JLu', NULL, 'indonesian_emperor@yahoo.co.id', '9f00c88698b8ad5afab01ec1b184979295d14a00', 'o7LHeORN.yC.YrA7RGqBrOcfe626ea2d096ac55d', 1479085720, NULL, 1478999969, NULL, 0, 'Dwita', 'Indriarti', 'UNAIR', '09989899');
