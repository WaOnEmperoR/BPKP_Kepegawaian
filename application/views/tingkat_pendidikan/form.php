				...
				<div class="panel-body collapse in">
					<form id="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>tingkat_pendidikan/simpan" method="post" class="form-horizontal row-border">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="hidden" class="form-control" name="id" value="<?php echo $ID_Tingkat_Pendidikan; ?>">
								<input type="text" class="form-control" name="nama_tingkat" value="<?php echo $Nama_Tingkat_Pendidikan; ?>" autofocus="true">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">Deskripsi </label>
							<div class="col-sm-6">
								<input type="text" class="form-control" name="deskripsi" value="<?php echo $Deskripsi_Tingkat_Pendidikan; ?>" autofocus="true">
							</div>
						</div>
