...
<div id="page-heading">
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>pelajaran"><?php echo $breadcumb; ?></a></li>
...
<form action="<?php echo base_url(); ?>pelajaran/simpan" method="post" class="form-horizontal row-border">
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input type="text" class="form-control numeric" name="bobot" value="<?php echo $bobot; ?>" autofocus="true">
    </div>
</div>
<div class="form-group">
