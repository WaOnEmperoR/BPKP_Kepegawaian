...
<div id="page-heading">
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>lokal_lulus_dinas"><?php echo $breadcumb; ?></a></li>
...
<form id="form" enctype="multipart/form-data" action="<?php echo base_url(); ?>lokal_lulus_dinas/simpan" method="post" class="form-horizontal row-border">
