			...
			<div class="panel panel-default">
				...
				<div class="panel-body collapse in">
					<div class="panel">
						...
						<!-- <a href="<?php //echo base_url(); ?>susunan_kepengurusan/tambah/<?php //echo($id_mitra);?>"> <button class="btn-primary btn"><i class="fa fa-plus"></i> Tambah</button></a> -->
					</div>
					<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="example">
						...
						<tbody>
							...
							<tr class="gradeA">
								...
								| <a href="<?php echo base_url(); ?>susunan_kepengurusan/hapus/<?php echo $db['ID_Susunan_Kepengurusan']; ?>/<?php echo $id_mitra; ?>"> <button class="btn-danger btn-sm" title="hapus" onClick="return confirm('Anda yakin ingin menghapus data ini?')"><i class="fa fa-trash-o"></i> Hapus</button> </a></td>
