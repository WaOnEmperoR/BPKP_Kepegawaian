                  ...
                  <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="example">
                    <thead>
                      <tr>
                        ...
                        <th>Nilai</th>
                        <th>Status</th>
                        <?php if(is_admin() || is_kepala_sekolah()){ ?>
                          <th>Aksi</th>
                        <?php } ?>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      <tr class="gradeA">
                        ...
                        <td><?php echo $db['nisn']; ?></td>
                        <td><?php echo $db['nm_siswa']; ?></td>
                        <td align="center"><?php echo $db['tgl_lahir_siswa']; ?></td>
                        <?php if(is_admin() || is_operator_disdik() || is_eksekutif()){ ?>
                        <td><?php echo $db['nm_sekolah']; ?></td>
                        <?php } ?>
                        <td align="center"><?php echo $db['nem']; ?></td>
                        <td align="center"><?php echo get_status_lulus($db['stat_lulus']); ?></td>
                        <?php if(is_admin() || is_kepala_sekolah()){ ?>
                          <td align="center"><a href="<?php echo base_url(); ?>sekolah_peringkat/ubah/<?php echo $db['id_seleksi']; ?>"><button class="btn-orange btn-sm" title="ubah"><i class="fa fa-edit"></i>Luluskan/Tolak</button></td>
                        <?php } ?>
                      </tr>
                      <?php
                      $no++;
